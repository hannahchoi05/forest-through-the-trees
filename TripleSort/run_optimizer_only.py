...
def main() -> None:
    ...
    # Reads the already-generated excess_ports.csv — no portfolio regeneration.
    ...
    if not portfolio_csv.exists():
        raise FileNotFoundError(
            f"Missing {portfolio_csv}. "
            "Run ts_portfolios_gen.py first to generate excess_ports.csv."
        )
    ...
    # -------------------------------------------------------------------------
    print("Running A1: LARS optimizer (no TC) — grid search...", flush=True)
    ...
    # -------------------------------------------------------------------------
    print("Running A2: LARS optimizer (stock-level TC)...", flush=True)
    ...
    # -------------------------------------------------------------------------
    # Align to common calendar and write comparison.
    # -------------------------------------------------------------------------
    common_start = max(
    ...
    print("Generate plots with: python3 TripleSort/run_plots.py", flush=True)
